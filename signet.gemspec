...
Gem::Specification.new do |s|
  ...
  s.files = [".yardopts".freeze, "CHANGELOG.md".freeze, "CODE_OF_CONDUCT.md".freeze, "LICENSE".freeze, "README.md".freeze, "SECURITY.md".freeze, "lib/signet.rb".freeze, "lib/signet/errors.rb".freeze, "lib/signet/oauth_1.rb".freeze, "lib/signet/oauth_1/client.rb".freeze, "lib/signet/oauth_1/credential.rb".freeze, "lib/signet/oauth_1/server.rb".freeze, "lib/signet/oauth_1/signature_methods/hmac_sha1.rb".freeze, "lib/signet/oauth_1/signature_methods/plaintext.rb".freeze, "lib/signet/oauth_1/signature_methods/rsa_sha1.rb".freeze, "lib/signet/oauth_2.rb".freeze, "lib/signet/oauth_2/client.rb".freeze, "lib/signet/version.rb".freeze]
